...
export default class GameText {
  ...
  gameOverText(score, bestScore, level) {
    ...
    this.p5.fill("#E02735");
    this.p5.noStroke();
    this.p5.rect(CANVAS_WIDTH / 2 - 100, CANVAS_HEIGHT / 2 - 200, 200, 50);

    // Draw text on top of the rectangle
    this.p5.textSize(25);
    this.p5.fill("white");
    this.p5.text("NOT SO EASY?", 0, CANVAS_HEIGHT / 2 - 165, CANVAS_WIDTH);
    ...
    this.p5.textSize(20);
    this.p5.text("CONTACT US NOW", 0, CANVAS_HEIGHT / 2 + 30, CANVAS_WIDTH);
